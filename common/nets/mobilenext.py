...
def MobileNeXt(input_shape, k, alpha=1.0):
    """MobileNetv2
    ...
    x = _sand_glass_block(x, 192, (3, 3), t=6, alpha=alpha, strides=2, n=1)
    x = _sand_glass_block(x, 288, (3, 3), t=6, alpha=alpha, strides=2, n=3)
    x = _sand_glass_block(x, 384, (3, 3), t=6, alpha=alpha, strides=1, n=3)
    x = _sand_glass_block(x, 576, (3, 3), t=6, alpha=alpha, strides=2, n=4)
    x = _sand_glass_block(x, 960, (3, 3), t=6, alpha=alpha, strides=1, n=3)
    x = _sand_glass_block(x, 1280, (3, 3), t=6, alpha=alpha, strides=1, n=1)


    if alpha > 1.0:
        last_filters = _make_divisible(2048 * alpha, 8)
    else:
        last_filters = 2048
...
if __name__ == '__main__':
    model = MobileNeXt((256, 256, 3), 100, 1.0)
    print(model.summary())