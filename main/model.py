    ...
    if is_train:
        if cfg.pre_train:
            if backbone_str == 'ResNet50':
                ...
                org_mobilenet.pop('features.18.0.weight', None)
                org_mobilenet.pop('features.18.1.weight', None)
                org_mobilenet.pop('features.18.1.bias', None)
                org_mobilenet.pop('features.18.1.running_mean', None)
                org_mobilenet.pop('features.18.1.running_var', None)
                org_mobilenet.pop('classifier.1.weight', None)
                org_mobilenet.pop('classifier.1.bias', None)
